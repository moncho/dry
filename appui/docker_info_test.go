...
var expectedDockerInfoWithSwarm = `  <blue>Docker Host:</>         <yellow>dry.io</>    <blue>Docker Version:</>  <yellow>1.0</>           <blue>Name:</>    <yellow>test</>   <blue>Swarm:</>  <yellow>active</>   
  <blue>Cert Path:</>           <yellow></>          <blue>APIVersion:</>      <yellow>1.27</>          <blue>CPU:</>     <yellow>2</>      <blue>Role:</>   <yellow>manager</>  
  <blue>Verify Certificate:</>  <yellow>false</>     <blue>OS/Arch/Kernel:</>  <yellow>dry/amd64/42</>  <blue>Memory:</>  <yellow>1 KiB</>  <blue>Nodes:</>  <yellow>0</>        
`

var expectedDockerInfoNoSwarm = `  <blue>Docker Host:</>         <yellow>dry.io</>    <blue>Docker Version:</>  <yellow>1.0</>           <blue>Name:</>    <yellow>test</>   <blue>Swarm:</>  <yellow>inactive</>  
  <blue>Cert Path:</>           <yellow></>          <blue>APIVersion:</>      <yellow>1.27</>          <blue>CPU:</>     <yellow>2</>      
  <blue>Verify Certificate:</>  <yellow>false</>     <blue>OS/Arch/Kernel:</>  <yellow>dry/amd64/42</>  <blue>Memory:</>  <yellow>1 KiB</>  
`
