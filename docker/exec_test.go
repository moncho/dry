...
func (m *execAPIClientMock) ContainerExecCreate(ctx context.Context, containerID string, config container.ExecOptions) (types.IDResponse, error) {
	m.lastExecOpts = config
	if m.createErr != nil {
		return types.IDResponse{}, m.createErr
	}
